...
class AnyApiClient:
    ...
    def create_challenge(self, public_key: str, verbose: bool = True) -> dict:
    ...
    def solve_challenge(self, encrypted_challenge: str, private_key: object, verbose: bool = True) -> uuid.UUID:
    ...
    def decrypt_provider_key_value(self, encrypted_key: str, private_key: object, verbose: bool = True) -> str:
